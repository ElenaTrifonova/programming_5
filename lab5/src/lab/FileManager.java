...
public class FileManager {
    ...
    public Hashtable<Long, Organization> loadCollection(String filePath) throws FileNotFoundException {
        ...
        try {
            ...
            Type typeOfCollection = new TypeToken<LinkedList<Organization>>() {
            }.getType();
            try {
                LinkedList<Organization> listOrg = gson.fromJson(stringBuilder.toString(), typeOfCollection); //подаем строку
                long key = 0;
                if (listOrg != null)
